  ...
  sections: [
...

    {
      ...
      paragraphs: [
        ...
        "Authentication is only the beginning. Authorisation has to follow the person and the record through every read and write. Private information must not appear in another role's view merely because the interface hides the field. Retention, recovery, and operational access still need deliberate answers.",
